-- =============================================================
--   STEP 4 — ALL 30 SQL ANALYTICAL QUERIES
-- =============================================================
--   How to use this file:
--   1. Open MySQL Workbench
--   2. Connect to 'debt_db' database
--   3. Open this file (File → Open SQL Script)
--   4. Run each query one by one (Ctrl+Enter on the query line)
--
--   OR run all queries from Python using step4_run_queries.py
--
--   TABLES REFERENCE:
--   ┌──────────────┬──────────────────────────────────────┐
--   │ countries    │ country_id, country_name, country_code│
--   │ indicators   │ indicator_id, indicator_name, code    │
--   │ debt_data    │ debt_id, country_id, indicator_id,debt│
--   └──────────────┴──────────────────────────────────────┘
-- =============================================================
